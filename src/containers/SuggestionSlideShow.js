...
import '../css/SuggestionSlideShow.css';
import '../css/App.css';
...
export default class SuggestionSlideShow extends Component {
    constructor() {
        super();
        this.state = {
            activeIndex: 0
    ...
    render() {
        ...
        return (
            <div className="slideshow3">
                ...
                <ul className="slideshow-slides3">
                    {
