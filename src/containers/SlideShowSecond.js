...
import '../css/SlideShowSecondPage.css'
...
export default class SlideShowSecondPage extends Component {
    constructor() {
        super();
        this.state = {
            activeIndex: 0
    ...
    render() {
        ...
        return (
            <div className="slideshow2">
                ...
                <ul className="slideshow-slides2">
                    {
